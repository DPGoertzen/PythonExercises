...
for i in colors:
  color_name = i
  col_count = str(color_count(i))
  color_count_summary += "{col_count} skeins of {color_name}\n".format(col_count=col_count, color_name=color_name)

print(color_count_summary)
